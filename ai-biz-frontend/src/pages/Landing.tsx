...
import { FileSearch, ShieldAlert, TrendingUp, MessageSquare, Zap } from 'lucide-react'
  ...
  return (
    <div className="bg-white text-ink-800">
      <header className="border-b border-ink-200 sticky top-0 bg-white/90 backdrop-blur z-40">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button onClick={() => navigate('/login')} className="text-sm font-semibold text-ink-700 hover:text-ink-900 px-3 py-2">
              Log in
            </button>
            <button
      ...
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-16 text-center">
        <span className="inline-block bg-brand-50 text-brand-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
          Powered by Gemini AI
        </span>
        <h1 className="text-4xl md:text-6xl font-extrabold text-ink-900 tracking-tight leading-[1.1] max-w-4xl mx-auto">
          Turn your business data into decisions, automatically
        </h1>
        <p className="mt-6 text-lg text-ink-600 max-w-2xl mx-auto">
          Upload your sales, financial, and operational data. AI Biz explains what's happening, why it's
          happening, and what to do next — no analyst required.
        </p>
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          <button
            ...
            className="border border-ink-300 hover:border-ink-400 text-ink-800 font-semibold px-6 py-3 rounded-lg transition text-sm"
          >
            View live demo
          </button>
        </div>
        ...
        <div className="mt-16 rounded-2xl border border-ink-200 shadow-2xl shadow-ink-200/50 overflow-hidden max-w-5xl mx-auto text-left">
          ...
          <div className="bg-brand-50/40 p-4 flex items-start gap-3">
            ...
            <p className="text-sm text-ink-700 leading-relaxed">
              <span className="font-semibold text-ink-900">Executive summary:</span> Revenue increased by 12% this
              quarter, driven primarily by strong product sales in the West region. Customer retention improved by
      ...
      <section id="features" className="bg-ink-50 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <h2 className="text-3xl font-bold text-ink-900">The problem with traditional BI tools</h2>
            <p className="mt-4 text-ink-600">
              Dashboards show you charts. They don't tell you why trends are happening or what to do about them.
              AI Biz closes that gap.
            </p>
          </div>
      ...
      <section id="how" className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ['Upload your data', 'Sales reports, financial statements, customer feedback, inventory records — CSV, Excel, or PDF.'],
              ['AI analyzes it', 'Gemini-powered analysis detects trends, anomalies, and risks, and generates an executive summary.'],
              ['Act on recommendations', 'Get specific, actionable recommendations and ask follow-up questions in natural language.'],
            ].map(([title, text], i) => (
      ...
      <section className="bg-brand-600 py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Make faster, smarter business decisions</h2>
          <p className="text-brand-100 mb-8">Join businesses using AI Biz to turn raw data into clear action.</p>
          <button
            onClick={() => navigate('/signup')}
      ...
      <footer className="border-t border-ink-200 py-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-ink-500">© 2026 AI Biz. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
