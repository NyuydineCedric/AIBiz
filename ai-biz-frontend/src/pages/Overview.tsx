...
export default function Overview() {
    ...
    return (
      <div className="p-6">
        <div className="bg-white rounded-xl border border-dashed border-ink-300 p-12 text-center">
          ...
          <p className="text-sm text-ink-500 mb-5">Log a day of sales/purchases, or upload a business report, to see charts and trends here.</p>
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-ink-500 mb-6">A visual read of your latest upload — trends, breakdowns, and a short-term forecast.</p>
        ...
        <div className="flex flex-col gap-6">
          {hasRegion && (
            <div className="bg-white rounded-xl border border-ink-200 p-6">
              <p className="text-sm font-semibold text-ink-900 mb-4">Top contributors</p>
